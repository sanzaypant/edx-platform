...
class SingleThreadQueryCountTestCase(ForumsEnableMixin, ModuleStoreTestCase):
    ...
    @ddt.data(
        ...
        (ModuleStoreEnum.Type.split, False, 1, 3, 3, 21, 7),
        (ModuleStoreEnum.Type.split, False, 50, 3, 3, 21, 7),

        # Enabling Enterprise integration should have no effect on the number of mongo queries made.
        (ModuleStoreEnum.Type.mongo, True, 1, 5, 2, 21, 7),
        (ModuleStoreEnum.Type.mongo, True, 50, 5, 2, 21, 7),
        # split mongo: 3 queries, regardless of thread response size.
        (ModuleStoreEnum.Type.split, True, 1, 3, 3, 21, 7),
        (ModuleStoreEnum.Type.split, True, 50, 3, 3, 21, 7),
    )
    @ddt.unpack
